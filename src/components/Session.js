  ...
  const handleConnect = () => {
    if (queryStringParse.signInFromScan) {
      window.opener.postMessage(
        { address: user.address, account: user.name },
        '*'
      );
      window.close();
    }
  ...
  return (
    <div>
      ...
      <form className="keystation-form">
        ...
        <br />
        <p>
          You MUST press "Save" in order to complete registration of your
          account. If this pop-up does not appear, please press the Key logo on
